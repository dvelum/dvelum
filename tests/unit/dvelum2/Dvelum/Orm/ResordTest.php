...
class RecordTest extends TestCase
{
    ...
    public function testSet()
    {
        ...
        try{
            $object_a->set('parent_id', new Record('User', User::getInstance()->id));
