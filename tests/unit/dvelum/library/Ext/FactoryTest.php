...
class Ext_FactoryTest extends TestCase
{
    public function testObject()
    {
        ...
        $this->assertEquals(Ext_Factory::object('Component_Window_System_Crud')->getClass(),
            'Component_Window_System_Crud');
        $this->assertEquals(Ext_Factory::object('Component_Window_System_Crud_Vc')->getClass(),
            'Component_Window_System_Crud_Vc');
        ...
        $o2 = Ext_Factory::object('Grid', ['width' => 100, 'height' => 20]);
        $this->assertEquals($o2->get('width'), 100);
        $this->assertEquals($o2->get('height'), 20);
    }
