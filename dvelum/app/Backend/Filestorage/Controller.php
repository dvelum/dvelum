...
class Backend_Filestorage_Controller extends Dvelum\App\Backend\Controller
{
    ...
    public function uploadAction()
    {
       ...
       $files = Request::files();
        ...
        if (!isset($files['file']) || empty($files['file'])){
            $this->response->error($this->_lang->get('FILL_FORM'));
        }
        ...
        if (empty($files)) {
            $this->response->error($this->_lang->get('CANT_EXEC'));
        }
