...
abstract class Frontend_Controller_Backoffice extends Backend_Controller{
    ...
    public function includeScripts(){
        $media = \Dvelum\Orm\Model::factory('Medialib');
    ...
    public function indexAction(){
        $this->_resource->addInlineJs('
         var canEdit = ' . intval($this->_user->getModuleAcl()->canEdit($this->_module)) . ';
         var canDelete = ' . intval($this->_user->getModuleAcl()->canDelete($this->_module)) . ';
         var canPublish = ' . intval($this->_user->getModuleAcl()->canPublish($this->_module)) . ';
        ');
        $this->includeScripts();
    }
