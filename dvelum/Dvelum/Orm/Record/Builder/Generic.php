...
abstract class Generic extends AbstractAdapter
{
    ...
    public function prepareColumnUpdates()
    {
        ...
        foreach($config['fields'] as $name => $v)
        {
            ...
            elseif(in_array($dataType , Builder::$numTypes , true) && isset(Orm\Record\Field\Property::$numberLength[$v['db_type']]))
            {
     ...
     * @throws \Exception
     */
    protected function getDataTypes(Metadata\Object\ColumnObject $column, Orm\Record\Config\Field $objectField) : array
    {
