...
Ext.define('frApp.Application',{
	...
	launch:function()
	{
		this.mainUrl = app.createUrl(designerUrlPaths);
		
		frApp.viewFrame = Ext.create('Ext.container.Viewport', {
			layout: 'fit',
			items:[],
		...
		frApp.externalCommandReceiver = Ext.create('Ext.form.field.Text',{
	...
	onComandRecieved:function(field , value){
    	...
    	frApp.externalCommandReceiver.setValue('');
    },
