...
Ext.define('designer.properties.Panel',{
	...
	this.sourceConfig = Ext.apply({
		...
		editor:Ext.create('Ext.form.field.Text',{
		    listeners:{
			focus:{
			    fn:function(){me.showDefaultsWindow('defaults');},
			    scope:me
			}
		    }
		})
		...
		editor:Ext.create('Ext.form.field.Text',{
		    listeners:{
			focus:{
			    fn:function(){me.showParamsWindow('extraParams');},
			    scope:me
			}
		    }
		})
		...
		editor:Ext.create('Ext.form.field.Text',{
		    listeners:{
			focus:{
			    fn:function(){me.showDefaultsWindow('fieldDefaults');},
			    scope:me
			}
		    }
		})
		...
		editor:Ext.create('Ext.form.field.Text',{
		    listeners:{
			focus:{
			    fn:function(){me.showDefaultsWindow('config');},
			    scope:me
			}
		    }
		})
	...
	this.customRenderers.defaults = function(v){return '...';};
	this.customRenderers.fieldDefaults = function(v){return '...';};
	this.customRenderers.extraParams = function(v){return '...';};
